    ...
    <div>
      <section id="services" className="container py-12 md:py-24 lg:space-y-12 space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
          ...
          {ServicesData.map((item) => (
            <CardContainer key={item.id} className="border-2 p-5 rounded-2xl">
              <CardItem>
                <CardBody>
                  <div className=" border h-16 w-16 p-1 rounded-2xl bg-primary/10 dark:bg-gradient-to-l dark:from-secondary/10 dark:to-darkprimary/5 flex justify-start items-center space-x-4">
                    <span className="text-3xl mx-auto text-primary">
                      {item.icons}
                    </span>
                  </div>
